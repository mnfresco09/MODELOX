...
class EstrategiaID1ZLEMA(EstrategiaBase):
    ...
    def suggest_params(self, trial: Any) -> Dict[str, Any]:
        ...
        """
        return {
            "fast":     trial.suggest_int  ("fast",     14,  70, step=2),
            "slow":     trial.suggest_int  ("slow",    100, 250, step=5),
    ...
    def generate_signals(self, df: pl.DataFrame, params: Dict[str, Any]) -> pl.DataFrame:
        ...
        params["__warmup_bars"]     = slow + fast + 10
        params["__indicators_used"] = ["hl2", "fast_ma", "slow_ma", "dist_norm_pct"]
